 ...
 * @param <deadmau5>
 */
public class SoundManager<deadmau5> {
	...
	private AudioClip playdeademau5Sound = Applet.newAudioClip(GameScreen.class.getResource("/rbadia/voidspace/sounds/Daft Punk - Giorgio by Moroder - Instrumental - from YouTube.wav"));
	...
	public void playdeadmau5Sound(){
		if(SOUND_ON){
			new Thread(new Runnable(){
				public void run() 
				{playdeademau5Sound.play();}
			}).start();
		}
	} 
